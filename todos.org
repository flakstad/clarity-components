...
* TODO when in edit mode, show always show space for the status label - allowing mouse users to change status label
* TODO agenda view: list all tasks across projects
* TODO agenda view: list day-scheduled/due tasks at the bottom
* TODO agenda view: show tasks in completed state in the agenda
