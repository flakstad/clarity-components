...
* TODO support setting hours/minutes for due and schedule
...
* TODO allow setting hours+minutes for due date etc
Or at least for schedule, if we support it, to allow adding meetings as items.
