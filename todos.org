...
* TODO update blogpost js - dark mode is broken
* TODO clicking in the comment or worklog popups closes them
...
* TODO clicking status label console logs error
...
* TODO must not be able to add a new item by alt+enter if add is disabled
...
Would need to update schedule to support adding repeating settings through popup.

Needs to be tested in a sort of agenda view, with a database query.
* TODO drag and drop?
