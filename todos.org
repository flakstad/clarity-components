...
* TODO navigate with emacs and vi default bindings
ctrl + npfb
hjkl
* TODO move item with emacs and vi default bindings
alt + npfb
alt + hjkl
* TODO toggle expand/collapse hierarchy
Check with AI if alt + tab is a default on some linux distros.
