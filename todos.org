...
alt + npfb
alt + hjkl
* TODO toggle expand/collapse hierarchy
Confirm with AI that alt + tab is a default for application switching on windows and some linux distros.
Have it suggest alternatives, with alt + something.., e.g. alt + h (hierarchy/hide)
* TODO status popup does not render current status
* TODO event "outline:navigate" should be renamed to "outline:open"
...
* TODO shift + up/down to toggle priority
* TODO alt + tab might be application switch in some Linux distros - problem
Don't want to override Tab.
* TODO notes popup must be bigger, or allow expansion when writing notes
...
* TODO supporting both scheduled and deadline timestamps?
